...
struct alice3task {
  ...
  Partition<alice3tracks> positiveTracks = ((aod::a3DecayMap::decayMap & trackSelectionPiPlusFromD) == trackSelectionPiPlusFromD &&
                                            nabs(aod::track::dcaXY) > minDCAxy &&
                                            nabs(aod::track::dcaZ) > minDCAz &&
                                            aod::otftracks::lutConfigId == otfConfig &&
                                            aod::track::signed1Pt > 0.0f);

  Partition<alice3tracks> negativeTracks = ((aod::a3DecayMap::decayMap & trackSelectionKaMinusFromD) == trackSelectionKaMinusFromD &&
                                            nabs(aod::track::dcaXY) > minDCAxy &&
                                            nabs(aod::track::dcaZ) > minDCAz &&
                                            aod::otftracks::lutConfigId == otfConfig &&
                                            aod::track::signed1Pt < 0.0f);
